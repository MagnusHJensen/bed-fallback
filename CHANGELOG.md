...
A spawn point whose bed or respawn anchor is still standing is now left alone. On a server a player can sleep without the night being skipped, and the mod used to send them back to an older bed on death.
